package com.xiaominfo.knife4j.demo.resolver;
...
public class MyRequestArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    public boolean supportsParameter(MethodParameter methodParameter) {
        return methodParameter.hasParameterAnnotation(TestBody.class);
    }
    ...
    public Object resolveArgument(MethodParameter parameter, ModelAndViewContainer modelAndViewContainer, NativeWebRequest webRequest, WebDataBinderFactory webDataBinderFactory) throws Exception {
        ...
        TestBody parameterAnnotation = parameter.getParameterAnnotation(TestBody.class);
    ...
    private JSONObject getRequestBody(NativeWebRequest webRequest) throws IOException {
        ...
        // 没有就从请求中读取
        if (jsonObject == null) {
            //IoUtil.toStr(servletRequest.getReader(), StandardCharsets.UTF_8)
            String jsonBody = IoUtil.read(servletRequest.getReader());
